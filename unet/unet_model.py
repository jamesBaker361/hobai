#stolen from https://github.com/mateuszbuda/brain-segmentation-pytorch/blob/master/unet.py
...
class UNetDiscriminator(UNet):
    ...
    def forward(self,x ):
        ...
        bottleneck = self.bottleneck(self.pool4(enc4))
        flatten=self.flatten(bottleneck)
        activation =self.activation(flatten)
